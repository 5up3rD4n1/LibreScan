...
def search():
    ...
    try:
        ...
        print('Failed to search: LuaError: ' + str(e.args) + '\nTraceback: ' + traceback.format_exc())
    except chdkptp.PTPError as e:
        print('Failed to search: PTPError: ' + str(
            e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
    except Exception as e:
        print('Failed to search: ' + str(e.args) + '\n' + traceback.format_exc())
    return result
...
class Camera:
    ...
    def log(self, message):
        print(self.position + ' camera: ' + message + ' -- self.message: ' + self.message)
    ...
    def prepare(self):
        ...
        if self.isReady:
            ...
            try:
                ...
                self.log('Failed while preparing: PTPError: ' + str(
                    e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
            except Exception as e:
    ...
    def prepare_whitebalance(self):
        ...
        self.device.lua_execute("set_prop(require('propcase').WB_MODE, " + str(self.whitebalance) + ");sleep(50);",
                                do_return=False)
    ...
    def refocus(self):
        ...
        try:
            if self.is_connected():
                ...
                self.device.lua_execute(
                    "sleep(50);press('shoot_half');sleep(500);release('shoot_half');sleep(50);set_aflock(1);sleep(50);",
                    do_return=False)
                success = True
            else:
            ...
            self.log('Failed to refocus: PTPError: ' + str(
                e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
        except Exception as e:
    ...
    def unlockFocus(self):
        ...
        try:
            ...
            self.log('Failed to unlock focus: PTPError: ' + str(
                e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
        except Exception as e:
    ...
    def connect(self):
        ...
        try:
            ...
            self.log('Failed to connect: PTPError: ' + str(
                e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
        except Exception as e:
    ...
    def capture(self, filename):
        ...
        try:
            ...
            if self.isReady and self.is_connected():
                ...
                if data:
                    ...
                    with open(filename + '.jpg', 'wb') as file:
                        file.write(str.encode(data, encoding='latin-1'))
                    result = filename
            ...
            self.log('Failed to capture: PTPError: ' + str(
                e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
        except Exception as e:
    ...
    def beepFail(self):
        try:
            ...
            self.log('Failed to beep: PTPError: ' + str(
                e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
        except Exception as e:
    ...
    def turnOff(self):
        try:
            ...
            self.log('Failed to power off: PTPError: ' + str(
                e.args) + '\n' + traceback.format_exc() + '\nPTP Traceback:\n' + e.traceback)
        except Exception as e:
...
def main():
    ...
    for camera in cameras:
        ...
        return_cameras.append(camera_instance)
        camera_instance.prepare()
